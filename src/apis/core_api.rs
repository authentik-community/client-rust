...
pub async fn core_application_entitlements_create(
    ...
    let p_application_entitlement_request = application_entitlement_request;
    ...
    req_builder = req_builder.json(&p_application_entitlement_request);
...
pub async fn core_application_entitlements_destroy(
    ...
    let uri_str = format!(
        ...
        pbm_uuid = crate::apis::urlencode(p_pbm_uuid)
    );
...
pub async fn core_application_entitlements_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_pbm_uuid = pbm_uuid;
    let p_patched_application_entitlement_request = patched_application_entitlement_request;
    ...
    req_builder = req_builder.json(&p_patched_application_entitlement_request);
...
pub async fn core_applications_list(
    ...
    let p_meta_launch_url = meta_launch_url;
    let p_meta_publisher = meta_publisher;
    let p_name = name;
    let p_only_with_launch_url = only_with_launch_url;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_search = search;
    let p_slug = slug;
    let p_superuser_full_list = superuser_full_list;
    ...
    if let Some(ref param_value) = p_meta_launch_url {
        req_builder = req_builder.query(&[("meta_launch_url", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_meta_publisher {
        req_builder = req_builder.query(&[("meta_publisher", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_name {
        req_builder = req_builder.query(&[("name", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_only_with_launch_url {
    ...
    if let Some(ref param_value) = p_superuser_full_list {
...
pub async fn core_applications_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_slug = slug;
    let p_patched_application_request = patched_application_request;
    ...
    req_builder = req_builder.json(&p_patched_application_request);
...
pub async fn core_authenticated_sessions_list(
    ...
    let p_page_size = page_size;
    let p_search = search;
    let p_session__last_ip = session__last_ip;
    let p_session__last_user_agent = session__last_user_agent;
    ...
    if let Some(ref param_value) = p_session__last_ip {
        req_builder = req_builder.query(&[("session__last_ip", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_session__last_user_agent {
...
pub async fn core_brands_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_brand_request = brand_request;
    ...
    req_builder = req_builder.json(&p_brand_request);
...
pub async fn core_brands_destroy(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_brand_uuid = brand_uuid;

    let uri_str = format!(
        "{}/core/brands/{brand_uuid}/",
        configuration.base_path,
        brand_uuid = crate::apis::urlencode(p_brand_uuid)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn core_brands_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_brand_uuid = brand_uuid;
    let p_branding_default_flow_background = branding_default_flow_background;
    let p_branding_favicon = branding_favicon;
    let p_branding_logo = branding_logo;
    let p_branding_title = branding_title;
    let p_client_certificates = client_certificates;
    let p_default = default;
    let p_domain = domain;
    let p_flow_authentication = flow_authentication;
    let p_flow_device_code = flow_device_code;
    let p_flow_invalidation = flow_invalidation;
    let p_flow_recovery = flow_recovery;
    let p_flow_unenrollment = flow_unenrollment;
    let p_flow_user_settings = flow_user_settings;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_search = search;
    let p_web_certificate = web_certificate;

    let uri_str = format!("{}/core/brands/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_brand_uuid {
        req_builder = req_builder.query(&[("brand_uuid", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_branding_default_flow_background {
        req_builder = req_builder.query(&[("branding_default_flow_background", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_branding_favicon {
        req_builder = req_builder.query(&[("branding_favicon", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_branding_logo {
        req_builder = req_builder.query(&[("branding_logo", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_branding_title {
        req_builder = req_builder.query(&[("branding_title", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_client_certificates {
    ...
    if let Some(ref param_value) = p_web_certificate {
...
pub async fn core_brands_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_brand_uuid = brand_uuid;
    let p_patched_brand_request = patched_brand_request;
    ...
    req_builder = req_builder.json(&p_patched_brand_request);
...
pub async fn core_groups_add_user_create(
    ...
    let p_user_account_request = user_account_request;

    let uri_str = format!(
        "{}/core/groups/{group_uuid}/add_user/",
        configuration.base_path,
        group_uuid = crate::apis::urlencode(p_group_uuid)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_user_account_request);
...
pub async fn core_groups_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_group_request = group_request;
    ...
    req_builder = req_builder.json(&p_group_request);
...
pub async fn core_groups_list(
    ...
    let p_members_by_username = members_by_username;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    ...
    if let Some(ref param_value) = p_members_by_pk {
        req_builder = match "multi" {
            "multi" => req_builder.query(
                &param_value
                    .into_iter()
    ...
    if let Some(ref param_value) = p_members_by_username {
        req_builder = match "multi" {
            "multi" => req_builder.query(
                &param_value
                    .into_iter()
...
pub async fn core_groups_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_group_uuid = group_uuid;
    let p_patched_group_request = patched_group_request;
    ...
    req_builder = req_builder.json(&p_patched_group_request);
...
pub async fn core_tokens_list(
    ...
    if let Some(ref param_value) = p_expiring {
    ...
    if let Some(ref param_value) = p_intent {
...
pub async fn core_tokens_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_identifier = identifier;
    let p_patched_token_request = patched_token_request;
    ...
    req_builder = req_builder.json(&p_patched_token_request);
...
pub async fn core_tokens_set_key_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_identifier = identifier;
    let p_token_set_key_request = token_set_key_request;
    ...
    req_builder = req_builder.json(&p_token_set_key_request);
...
pub async fn core_transactional_applications_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_transaction_application_request = transaction_application_request;
    ...
    req_builder = req_builder.json(&p_transaction_application_request);
...
pub async fn core_user_consent_destroy(
    ...
    let uri_str = format!("{}/core/user_consent/{id}/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn core_user_consent_used_by_list(
    ...
    let uri_str = format!("{}/core/user_consent/{id}/used_by/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn core_users_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_request = user_request;
    ...
    req_builder = req_builder.json(&p_user_request);
...
pub async fn core_users_destroy(
    ...
    let uri_str = format!("{}/core/users/{id}/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn core_users_impersonate_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_impersonation_request = impersonation_request;

    let uri_str = format!("{}/core/users/{id}/impersonate/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_impersonation_request);
...
pub async fn core_users_list(
    ...
    let p_page_size = page_size;
    let p_path = path;
    let p_path_startswith = path_startswith;
    let p_search = search;
    let p_type = r#type;
    ...
    if let Some(ref param_value) = p_groups_by_name {
        req_builder = match "multi" {
            "multi" => req_builder.query(
                &param_value
                    .into_iter()
    ...
    if let Some(ref param_value) = p_groups_by_pk {
        req_builder = match "multi" {
            "multi" => req_builder.query(
                &param_value
                    .into_iter()
    ...
    if let Some(ref param_value) = p_path_startswith {
...
pub async fn core_users_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_user_request = patched_user_request;
    ...
    req_builder = req_builder.json(&p_patched_user_request);
...
pub async fn core_users_recovery_create(
    ...
    let uri_str = format!("{}/core/users/{id}/recovery/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn core_users_recovery_email_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_email_stage = email_stage;
    let p_id = id;

    let uri_str = format!("{}/core/users/{id}/recovery_email/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);

    req_builder = req_builder.query(&[("email_stage", &p_email_stage.to_string())]);
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    if let Some(ref token) = configuration.bearer_access_token {
...
pub async fn core_users_service_account_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_service_account_request = user_service_account_request;
    ...
    req_builder = req_builder.json(&p_user_service_account_request);
...
pub async fn core_users_set_password_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_user_password_set_request = user_password_set_request;

    let uri_str = format!("{}/core/users/{id}/set_password/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_user_password_set_request);
...
pub async fn core_users_used_by_list(
    ...
    let uri_str = format!("{}/core/users/{id}/used_by/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
