...
pub async fn events_events_create(
    ...
    let p_event_request = event_request;
    ...
    req_builder = req_builder.json(&p_event_request);
...
pub async fn events_events_destroy(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_event_uuid = event_uuid;

    let uri_str = format!(
        "{}/events/events/{event_uuid}/",
        configuration.base_path,
        event_uuid = crate::apis::urlencode(p_event_uuid)
    );
...
pub async fn events_events_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_action = action;
    let p_actions = actions;
    let p_brand_name = brand_name;
    let p_client_ip = client_ip;
    let p_context_authorized_app = context_authorized_app;
    let p_context_model_app = context_model_app;
    let p_context_model_name = context_model_name;
    let p_context_model_pk = context_model_pk;
    ...
    if let Some(ref param_value) = p_actions {
...
pub async fn events_events_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_event_uuid = event_uuid;
    let p_patched_event_request = patched_event_request;
    ...
    req_builder = req_builder.json(&p_patched_event_request);
...
pub async fn events_events_top_per_user_list(
    ...
    if let Some(ref param_value) = p_top_n {
...
pub async fn events_events_volume_list(
    ...
    let p_context_model_name = context_model_name;
    let p_context_model_pk = context_model_pk;
    let p_history_days = history_days;
    let p_ordering = ordering;
    let p_search = search;
    let p_username = username;
    ...
    if let Some(ref param_value) = p_history_days {
...
pub async fn events_notifications_list(
    ...
    if let Some(ref param_value) = p_body {
    ...
    if let Some(ref param_value) = p_seen {
...
pub async fn events_notifications_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_uuid = uuid;
    let p_patched_notification_request = patched_notification_request;
    ...
    req_builder = req_builder.json(&p_patched_notification_request);
...
pub async fn events_notifications_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_uuid = uuid;
    let p_notification_request = notification_request;
    ...
    req_builder = req_builder.json(&p_notification_request);
...
pub async fn events_rules_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_notification_rule_request = notification_rule_request;
    ...
    req_builder = req_builder.json(&p_notification_rule_request);
...
pub async fn events_rules_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_destination_group__name = destination_group__name;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    ...
    if let Some(ref param_value) = p_destination_group__name {
...
pub async fn events_rules_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_pbm_uuid = pbm_uuid;
    let p_patched_notification_rule_request = patched_notification_rule_request;
    ...
    req_builder = req_builder.json(&p_patched_notification_rule_request);
...
pub async fn events_transports_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_notification_transport_request = notification_transport_request;
    ...
    req_builder = req_builder.json(&p_notification_transport_request);
...
pub async fn events_transports_list(
    ...
    let p_page_size = page_size;
    let p_search = search;
    let p_send_once = send_once;
    let p_webhook_url = webhook_url;
    ...
    if let Some(ref param_value) = p_send_once {
        req_builder = req_builder.query(&[("send_once", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_webhook_url {
...
pub async fn events_transports_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_uuid = uuid;
    let p_patched_notification_transport_request = patched_notification_transport_request;
    ...
    req_builder = req_builder.json(&p_patched_notification_transport_request);
