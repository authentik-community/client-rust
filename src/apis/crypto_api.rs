...
pub async fn crypto_certificatekeypairs_create(
    ...
    let p_certificate_key_pair_request = certificate_key_pair_request;
    ...
    req_builder = req_builder.json(&p_certificate_key_pair_request);
...
pub async fn crypto_certificatekeypairs_destroy(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_kp_uuid = kp_uuid;

    let uri_str = format!(
        "{}/crypto/certificatekeypairs/{kp_uuid}/",
        configuration.base_path,
        kp_uuid = crate::apis::urlencode(p_kp_uuid)
    );
...
pub async fn crypto_certificatekeypairs_generate_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_certificate_generation_request = certificate_generation_request;
    ...
    req_builder = req_builder.json(&p_certificate_generation_request);
...
pub async fn crypto_certificatekeypairs_list(
    ...
    if let Some(ref param_value) = p_has_key {
...
pub async fn crypto_certificatekeypairs_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_kp_uuid = kp_uuid;
    let p_patched_certificate_key_pair_request = patched_certificate_key_pair_request;
    ...
    req_builder = req_builder.json(&p_patched_certificate_key_pair_request);
