...
pub async fn sources_group_connections_all_list(
    ...
    let p_page_size = page_size;
    let p_search = search;
    let p_source__slug = source__slug;
    ...
    if let Some(ref param_value) = p_source__slug {
...
pub async fn sources_group_connections_all_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_group_source_connection_request = patched_group_source_connection_request;
    ...
    req_builder = req_builder.json(&p_patched_group_source_connection_request);
...
pub async fn sources_group_connections_all_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_group_source_connection_request = group_source_connection_request;
    ...
    req_builder = req_builder.json(&p_group_source_connection_request);
...
pub async fn sources_group_connections_kerberos_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_group_kerberos_source_connection_request = group_kerberos_source_connection_request;
    ...
    req_builder = req_builder.json(&p_group_kerberos_source_connection_request);
...
pub async fn sources_group_connections_kerberos_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_group_kerberos_source_connection_request = patched_group_kerberos_source_connection_request;
    ...
    req_builder = req_builder.json(&p_patched_group_kerberos_source_connection_request);
...
pub async fn sources_group_connections_ldap_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_group_ldap_source_connection_request = group_ldap_source_connection_request;
    ...
    req_builder = req_builder.json(&p_group_ldap_source_connection_request);
...
pub async fn sources_group_connections_ldap_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_group_ldap_source_connection_request = patched_group_ldap_source_connection_request;
    ...
    req_builder = req_builder.json(&p_patched_group_ldap_source_connection_request);
...
pub async fn sources_group_connections_oauth_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_group_o_auth_source_connection_request = group_o_auth_source_connection_request;
    ...
    req_builder = req_builder.json(&p_group_o_auth_source_connection_request);
...
pub async fn sources_group_connections_oauth_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_group_o_auth_source_connection_request = patched_group_o_auth_source_connection_request;
    ...
    req_builder = req_builder.json(&p_patched_group_o_auth_source_connection_request);
...
pub async fn sources_group_connections_plex_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_group_plex_source_connection_request = group_plex_source_connection_request;
    ...
    req_builder = req_builder.json(&p_group_plex_source_connection_request);
...
pub async fn sources_group_connections_plex_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_group_plex_source_connection_request = patched_group_plex_source_connection_request;
    ...
    req_builder = req_builder.json(&p_patched_group_plex_source_connection_request);
...
pub async fn sources_group_connections_saml_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_group_saml_source_connection_request = group_saml_source_connection_request;
    ...
    req_builder = req_builder.json(&p_group_saml_source_connection_request);
...
pub async fn sources_group_connections_saml_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_group_saml_source_connection_request = patched_group_saml_source_connection_request;
    ...
    req_builder = req_builder.json(&p_patched_group_saml_source_connection_request);
...
pub async fn sources_kerberos_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_kerberos_source_request = kerberos_source_request;
    ...
    req_builder = req_builder.json(&p_kerberos_source_request);
...
pub async fn sources_kerberos_list(
    ...
    let p_kadmin_type = kadmin_type;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_password_login_update_internal_password = password_login_update_internal_password;
    let p_pbm_uuid = pbm_uuid;
    let p_realm = realm;
    let p_search = search;
    let p_slug = slug;
    let p_spnego_server_name = spnego_server_name;
    let p_sync_principal = sync_principal;
    let p_sync_users = sync_users;
    let p_sync_users_password = sync_users_password;
    ...
    if let Some(ref param_value) = p_kadmin_type {
    ...
    if let Some(ref param_value) = p_password_login_update_internal_password {
        req_builder = req_builder.query(&[("password_login_update_internal_password", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_pbm_uuid {
        req_builder = req_builder.query(&[("pbm_uuid", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_realm {
...
pub async fn sources_kerberos_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_slug = slug;
    let p_patched_kerberos_source_request = patched_kerberos_source_request;
    ...
    req_builder = req_builder.json(&p_patched_kerberos_source_request);
...
pub async fn sources_ldap_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ldap_source_request = ldap_source_request;
    ...
    req_builder = req_builder.json(&p_ldap_source_request);
...
pub async fn sources_ldap_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_additional_group_dn = additional_group_dn;
    let p_additional_user_dn = additional_user_dn;
    let p_base_dn = base_dn;
    let p_bind_cn = bind_cn;
    let p_client_certificate = client_certificate;
    let p_delete_not_found_objects = delete_not_found_objects;
    let p_enabled = enabled;
    let p_group_membership_field = group_membership_field;
    let p_group_object_filter = group_object_filter;
    let p_group_property_mappings = group_property_mappings;
    let p_lookup_groups_from_user = lookup_groups_from_user;
    let p_name = name;
    let p_object_uniqueness_field = object_uniqueness_field;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_password_login_update_internal_password = password_login_update_internal_password;
    let p_pbm_uuid = pbm_uuid;
    let p_peer_certificate = peer_certificate;
    let p_search = search;
    let p_server_uri = server_uri;
    let p_slug = slug;
    let p_sni = sni;
    let p_start_tls = start_tls;
    let p_sync_groups = sync_groups;
    let p_sync_parent_group = sync_parent_group;
    let p_sync_users = sync_users;
    let p_sync_users_password = sync_users_password;
    let p_user_membership_attribute = user_membership_attribute;
    let p_user_object_filter = user_object_filter;
    let p_user_property_mappings = user_property_mappings;

    let uri_str = format!("{}/sources/ldap/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_additional_group_dn {
        req_builder = req_builder.query(&[("additional_group_dn", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_additional_user_dn {
        req_builder = req_builder.query(&[("additional_user_dn", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_base_dn {
        req_builder = req_builder.query(&[("base_dn", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_bind_cn {
        req_builder = req_builder.query(&[("bind_cn", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_client_certificate {
        req_builder = req_builder.query(&[("client_certificate", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_delete_not_found_objects {
        req_builder = req_builder.query(&[("delete_not_found_objects", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_enabled {
        req_builder = req_builder.query(&[("enabled", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_group_membership_field {
        req_builder = req_builder.query(&[("group_membership_field", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_group_object_filter {
        req_builder = req_builder.query(&[("group_object_filter", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_group_property_mappings {
    ...
    if let Some(ref param_value) = p_lookup_groups_from_user {
        req_builder = req_builder.query(&[("lookup_groups_from_user", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_name {
        req_builder = req_builder.query(&[("name", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_object_uniqueness_field {
    ...
    if let Some(ref param_value) = p_user_membership_attribute {
        req_builder = req_builder.query(&[("user_membership_attribute", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_user_object_filter {
        req_builder = req_builder.query(&[("user_object_filter", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_user_property_mappings {
        req_builder = match "multi" {
            "multi" => req_builder.query(
                &param_value
                    .into_iter()
...
pub async fn sources_ldap_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_slug = slug;
    let p_patched_ldap_source_request = patched_ldap_source_request;
    ...
    req_builder = req_builder.json(&p_patched_ldap_source_request);
...
pub async fn sources_oauth_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_o_auth_source_request = o_auth_source_request;
    ...
    req_builder = req_builder.json(&p_o_auth_source_request);
...
pub async fn sources_oauth_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_access_token_url = access_token_url;
    let p_additional_scopes = additional_scopes;
    let p_authentication_flow = authentication_flow;
    let p_authorization_url = authorization_url;
    let p_consumer_key = consumer_key;
    let p_enabled = enabled;
    let p_enrollment_flow = enrollment_flow;
    let p_group_matching_mode = group_matching_mode;
    let p_has_jwks = has_jwks;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    ...
    let p_profile_url = profile_url;
    let p_provider_type = provider_type;
    let p_request_token_url = request_token_url;
    let p_search = search;
    let p_slug = slug;
    let p_user_matching_mode = user_matching_mode;

    let uri_str = format!("{}/sources/oauth/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_access_token_url {
        req_builder = req_builder.query(&[("access_token_url", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_additional_scopes {
        req_builder = req_builder.query(&[("additional_scopes", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_authentication_flow {
        req_builder = req_builder.query(&[("authentication_flow", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_authorization_url {
        req_builder = req_builder.query(&[("authorization_url", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_consumer_key {
    ...
    if let Some(ref param_value) = p_group_matching_mode {
        req_builder = req_builder.query(&[("group_matching_mode", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_has_jwks {
    ...
    if let Some(ref param_value) = p_profile_url {
        req_builder = req_builder.query(&[("profile_url", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_provider_type {
        req_builder = req_builder.query(&[("provider_type", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_request_token_url {
    ...
    if let Some(ref param_value) = p_user_matching_mode {
...
pub async fn sources_oauth_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_slug = slug;
    let p_patched_o_auth_source_request = patched_o_auth_source_request;
    ...
    req_builder = req_builder.json(&p_patched_o_auth_source_request);
...
pub async fn sources_plex_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_plex_source_request = plex_source_request;
    ...
    req_builder = req_builder.json(&p_plex_source_request);
...
pub async fn sources_plex_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_allow_friends = allow_friends;
    let p_authentication_flow = authentication_flow;
    ...
    if let Some(ref param_value) = p_allow_friends {
...
pub async fn sources_plex_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_slug = slug;
    let p_patched_plex_source_request = patched_plex_source_request;
    ...
    req_builder = req_builder.json(&p_patched_plex_source_request);
...
pub async fn sources_plex_redeem_token_authenticated_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_plex_token_redeem_request = plex_token_redeem_request;
    let p_slug = slug;
    ...
    req_builder = req_builder.json(&p_plex_token_redeem_request);
...
pub async fn sources_saml_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_saml_source_request = saml_source_request;
    ...
    req_builder = req_builder.json(&p_saml_source_request);
...
pub async fn sources_saml_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_allow_idp_initiated = allow_idp_initiated;
    let p_authentication_flow = authentication_flow;
    let p_binding_type = binding_type;
    ...
    let p_managed = managed;
    let p_name = name;
    let p_name_id_policy = name_id_policy;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_pbm_uuid = pbm_uuid;
    let p_policy_engine_mode = policy_engine_mode;
    let p_pre_authentication_flow = pre_authentication_flow;
    let p_search = search;
    let p_signature_algorithm = signature_algorithm;
    let p_signing_kp = signing_kp;
    let p_slo_url = slo_url;
    let p_slug = slug;
    let p_sso_url = sso_url;
    let p_temporary_user_delete_after = temporary_user_delete_after;
    let p_user_matching_mode = user_matching_mode;
    let p_verification_kp = verification_kp;

    let uri_str = format!("{}/sources/saml/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_allow_idp_initiated {
        req_builder = req_builder.query(&[("allow_idp_initiated", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_authentication_flow {
        req_builder = req_builder.query(&[("authentication_flow", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_binding_type {
        req_builder = req_builder.query(&[("binding_type", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_digest_algorithm {
    ...
    if let Some(ref param_value) = p_name_id_policy {
...
pub async fn sources_saml_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_slug = slug;
    let p_patched_saml_source_request = patched_saml_source_request;
    ...
    req_builder = req_builder.json(&p_patched_saml_source_request);
...
pub async fn sources_scim_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_scim_source_request = scim_source_request;
    ...
    req_builder = req_builder.json(&p_scim_source_request);
...
pub async fn sources_scim_groups_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_scim_source_group_request = scim_source_group_request;
    ...
    req_builder = req_builder.json(&p_scim_source_group_request);
...
pub async fn sources_scim_groups_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_group__group_uuid = group__group_uuid;
    let p_group__name = group__name;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_search = search;
    ...
    if let Some(ref param_value) = p_group__group_uuid {
        req_builder = req_builder.query(&[("group__group_uuid", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_group__name {
...
pub async fn sources_scim_groups_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_scim_source_group_request = patched_scim_source_group_request;
    ...
    req_builder = req_builder.json(&p_patched_scim_source_group_request);
...
pub async fn sources_scim_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_slug = slug;
    let p_patched_scim_source_request = patched_scim_source_request;
    ...
    req_builder = req_builder.json(&p_patched_scim_source_request);
...
pub async fn sources_scim_users_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_scim_source_user_request = scim_source_user_request;
    ...
    req_builder = req_builder.json(&p_scim_source_user_request);
...
pub async fn sources_scim_users_list(
    ...
    let p_search = search;
    let p_source__slug = source__slug;
    let p_user__id = user__id;
    let p_user__username = user__username;
    ...
    if let Some(ref param_value) = p_user__id {
        req_builder = req_builder.query(&[("user__id", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_user__username {
...
pub async fn sources_scim_users_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_scim_source_user_request = patched_scim_source_user_request;
    ...
    req_builder = req_builder.json(&p_patched_scim_source_user_request);
...
pub async fn sources_user_connections_all_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_user_source_connection_request = patched_user_source_connection_request;
    ...
    req_builder = req_builder.json(&p_patched_user_source_connection_request);
...
pub async fn sources_user_connections_all_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_user_source_connection_request = user_source_connection_request;
    ...
    req_builder = req_builder.json(&p_user_source_connection_request);
...
pub async fn sources_user_connections_kerberos_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_kerberos_source_connection_request = user_kerberos_source_connection_request;
    ...
    req_builder = req_builder.json(&p_user_kerberos_source_connection_request);
...
pub async fn sources_user_connections_kerberos_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_user_kerberos_source_connection_request = patched_user_kerberos_source_connection_request;
    ...
    req_builder = req_builder.json(&p_patched_user_kerberos_source_connection_request);
...
pub async fn sources_user_connections_ldap_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_ldap_source_connection_request = user_ldap_source_connection_request;
    ...
    req_builder = req_builder.json(&p_user_ldap_source_connection_request);
...
pub async fn sources_user_connections_ldap_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_user_ldap_source_connection_request = patched_user_ldap_source_connection_request;
    ...
    req_builder = req_builder.json(&p_patched_user_ldap_source_connection_request);
...
pub async fn sources_user_connections_oauth_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_o_auth_source_connection_request = user_o_auth_source_connection_request;
    ...
    req_builder = req_builder.json(&p_user_o_auth_source_connection_request);
...
pub async fn sources_user_connections_oauth_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_user_o_auth_source_connection_request = patched_user_o_auth_source_connection_request;
    ...
    req_builder = req_builder.json(&p_patched_user_o_auth_source_connection_request);
...
pub async fn sources_user_connections_plex_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_plex_source_connection_request = user_plex_source_connection_request;
    ...
    req_builder = req_builder.json(&p_user_plex_source_connection_request);
...
pub async fn sources_user_connections_plex_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_user_plex_source_connection_request = patched_user_plex_source_connection_request;
    ...
    req_builder = req_builder.json(&p_patched_user_plex_source_connection_request);
...
pub async fn sources_user_connections_saml_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_saml_source_connection_request = user_saml_source_connection_request;
    ...
    req_builder = req_builder.json(&p_user_saml_source_connection_request);
...
pub async fn sources_user_connections_saml_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_user_saml_source_connection_request = patched_user_saml_source_connection_request;
    ...
    req_builder = req_builder.json(&p_patched_user_saml_source_connection_request);
