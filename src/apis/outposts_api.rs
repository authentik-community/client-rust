...
pub async fn outposts_instances_create(
    ...
    let p_outpost_request = outpost_request;
    ...
    req_builder = req_builder.json(&p_outpost_request);
...
pub async fn outposts_instances_health_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_uuid = uuid;
    let p_managed__icontains = managed__icontains;
    let p_managed__iexact = managed__iexact;
    let p_name__icontains = name__icontains;
    let p_name__iexact = name__iexact;
    let p_ordering = ordering;
    let p_providers__isnull = providers__isnull;
    let p_providers_by_pk = providers_by_pk;
    let p_search = search;
    let p_service_connection__name__icontains = service_connection__name__icontains;
    let p_service_connection__name__iexact = service_connection__name__iexact;
    ...
    if let Some(ref param_value) = p_managed__icontains {
        req_builder = req_builder.query(&[("managed__icontains", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_managed__iexact {
    ...
    if let Some(ref param_value) = p_providers__isnull {
        req_builder = req_builder.query(&[("providers__isnull", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_providers_by_pk {
    ...
    if let Some(ref param_value) = p_service_connection__name__icontains {
        req_builder = req_builder.query(&[("service_connection__name__icontains", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_service_connection__name__iexact {
...
pub async fn outposts_instances_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_uuid = uuid;
    let p_patched_outpost_request = patched_outpost_request;
    ...
    req_builder = req_builder.json(&p_patched_outpost_request);
...
pub async fn outposts_ldap_access_check(
    ...
    if let Some(ref param_value) = p_app_slug {
...
pub async fn outposts_service_connections_docker_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_docker_service_connection_request = docker_service_connection_request;
    ...
    req_builder = req_builder.json(&p_docker_service_connection_request);
...
pub async fn outposts_service_connections_docker_list(
    ...
    let p_page_size = page_size;
    let p_search = search;
    let p_tls_authentication = tls_authentication;
    let p_tls_verification = tls_verification;
    let p_url = url;

    let uri_str = format!("{}/outposts/service_connections/docker/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_local {
    ...
    if let Some(ref param_value) = p_tls_authentication {
        req_builder = req_builder.query(&[("tls_authentication", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_tls_verification {
...
pub async fn outposts_service_connections_docker_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_uuid = uuid;
    let p_patched_docker_service_connection_request = patched_docker_service_connection_request;
    ...
    req_builder = req_builder.json(&p_patched_docker_service_connection_request);
...
pub async fn outposts_service_connections_kubernetes_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_kubernetes_service_connection_request = kubernetes_service_connection_request;
    ...
    req_builder = req_builder.json(&p_kubernetes_service_connection_request);
...
pub async fn outposts_service_connections_kubernetes_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_uuid = uuid;
    let p_patched_kubernetes_service_connection_request = patched_kubernetes_service_connection_request;
    ...
    req_builder = req_builder.json(&p_patched_kubernetes_service_connection_request);
