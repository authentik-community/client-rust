...
pub async fn policies_all_destroy(
    ...
    let p_policy_uuid = policy_uuid;

    let uri_str = format!(
        "{}/policies/all/{policy_uuid}/",
        configuration.base_path,
        policy_uuid = crate::apis::urlencode(p_policy_uuid)
    );
...
pub async fn policies_all_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_bindings__isnull = bindings__isnull;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_promptstage__isnull = promptstage__isnull;
    let p_search = search;

    let uri_str = format!("{}/policies/all/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_bindings__isnull {
    ...
    if let Some(ref param_value) = p_promptstage__isnull {
...
pub async fn policies_all_test_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_uuid = policy_uuid;
    let p_policy_test_request = policy_test_request;
    ...
    req_builder = req_builder.json(&p_policy_test_request);
...
pub async fn policies_bindings_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_binding_request = policy_binding_request;
    ...
    req_builder = req_builder.json(&p_policy_binding_request);
...
pub async fn policies_bindings_destroy(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_binding_uuid = policy_binding_uuid;

    let uri_str = format!(
        "{}/policies/bindings/{policy_binding_uuid}/",
        configuration.base_path,
        policy_binding_uuid = crate::apis::urlencode(p_policy_binding_uuid)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn policies_bindings_list(
    ...
    let p_page_size = page_size;
    let p_policy = policy;
    let p_policy__isnull = policy__isnull;
    let p_search = search;
    let p_target = target;
    let p_target_in = target_in;
    ...
    if let Some(ref param_value) = p_policy {
        req_builder = req_builder.query(&[("policy", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_policy__isnull {
    ...
    if let Some(ref param_value) = p_target_in {
...
pub async fn policies_bindings_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_binding_uuid = policy_binding_uuid;
    let p_patched_policy_binding_request = patched_policy_binding_request;
    ...
    req_builder = req_builder.json(&p_patched_policy_binding_request);
...
pub async fn policies_dummy_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_dummy_policy_request = dummy_policy_request;
    ...
    req_builder = req_builder.json(&p_dummy_policy_request);
...
pub async fn policies_dummy_list(
    ...
    let p_execution_logging = execution_logging;
    ...
    let p_result = result;
    let p_search = search;
    let p_wait_max = wait_max;
    let p_wait_min = wait_min;
    ...
    if let Some(ref param_value) = p_execution_logging {
    ...
    if let Some(ref param_value) = p_policy_uuid {
    ...
    if let Some(ref param_value) = p_wait_max {
        req_builder = req_builder.query(&[("wait_max", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_wait_min {
...
pub async fn policies_dummy_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_uuid = policy_uuid;
    let p_patched_dummy_policy_request = patched_dummy_policy_request;
    ...
    req_builder = req_builder.json(&p_patched_dummy_policy_request);
...
pub async fn policies_event_matcher_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_event_matcher_policy_request = event_matcher_policy_request;
    ...
    req_builder = req_builder.json(&p_event_matcher_policy_request);
...
pub async fn policies_event_matcher_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_uuid = policy_uuid;
    let p_patched_event_matcher_policy_request = patched_event_matcher_policy_request;
    ...
    req_builder = req_builder.json(&p_patched_event_matcher_policy_request);
...
pub async fn policies_expression_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_expression_policy_request = expression_policy_request;
    ...
    req_builder = req_builder.json(&p_expression_policy_request);
...
pub async fn policies_expression_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_uuid = policy_uuid;
    let p_patched_expression_policy_request = patched_expression_policy_request;
    ...
    req_builder = req_builder.json(&p_patched_expression_policy_request);
...
pub async fn policies_geoip_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_geo_ip_policy_request = geo_ip_policy_request;
    ...
    req_builder = req_builder.json(&p_geo_ip_policy_request);
...
pub async fn policies_geoip_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_uuid = policy_uuid;
    let p_patched_geo_ip_policy_request = patched_geo_ip_policy_request;
    ...
    req_builder = req_builder.json(&p_patched_geo_ip_policy_request);
...
pub async fn policies_password_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_password_policy_request = password_policy_request;
    ...
    req_builder = req_builder.json(&p_password_policy_request);
...
pub async fn policies_password_expiry_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_password_expiry_policy_request = password_expiry_policy_request;
    ...
    req_builder = req_builder.json(&p_password_expiry_policy_request);
...
pub async fn policies_password_expiry_list(
    ...
    if let Some(ref param_value) = p_deny_only {
...
pub async fn policies_password_expiry_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_uuid = policy_uuid;
    let p_patched_password_expiry_policy_request = patched_password_expiry_policy_request;
    ...
    req_builder = req_builder.json(&p_patched_password_expiry_policy_request);
...
pub async fn policies_password_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_amount_digits = amount_digits;
    let p_amount_lowercase = amount_lowercase;
    let p_amount_symbols = amount_symbols;
    let p_amount_uppercase = amount_uppercase;
    let p_check_have_i_been_pwned = check_have_i_been_pwned;
    let p_check_static_rules = check_static_rules;
    let p_check_zxcvbn = check_zxcvbn;
    let p_created = created;
    let p_error_message = error_message;
    let p_execution_logging = execution_logging;
    let p_hibp_allowed_count = hibp_allowed_count;
    let p_last_updated = last_updated;
    let p_length_min = length_min;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_password_field = password_field;
    let p_policy_uuid = policy_uuid;
    let p_search = search;
    let p_symbol_charset = symbol_charset;
    let p_zxcvbn_score_threshold = zxcvbn_score_threshold;

    let uri_str = format!("{}/policies/password/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_amount_digits {
        req_builder = req_builder.query(&[("amount_digits", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_amount_lowercase {
        req_builder = req_builder.query(&[("amount_lowercase", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_amount_symbols {
        req_builder = req_builder.query(&[("amount_symbols", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_amount_uppercase {
        req_builder = req_builder.query(&[("amount_uppercase", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_check_have_i_been_pwned {
        req_builder = req_builder.query(&[("check_have_i_been_pwned", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_check_static_rules {
        req_builder = req_builder.query(&[("check_static_rules", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_check_zxcvbn {
        req_builder = req_builder.query(&[("check_zxcvbn", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_created {
        req_builder = req_builder.query(&[("created", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_error_message {
        req_builder = req_builder.query(&[("error_message", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_execution_logging {
        req_builder = req_builder.query(&[("execution_logging", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_hibp_allowed_count {
        req_builder = req_builder.query(&[("hibp_allowed_count", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_last_updated {
        req_builder = req_builder.query(&[("last_updated", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_length_min {
    ...
    if let Some(ref param_value) = p_password_field {
    ...
    if let Some(ref param_value) = p_symbol_charset {
        req_builder = req_builder.query(&[("symbol_charset", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_zxcvbn_score_threshold {
...
pub async fn policies_password_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_uuid = policy_uuid;
    let p_patched_password_policy_request = patched_password_policy_request;
    ...
    req_builder = req_builder.json(&p_patched_password_policy_request);
...
pub async fn policies_reputation_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_reputation_policy_request = reputation_policy_request;
    ...
    req_builder = req_builder.json(&p_reputation_policy_request);
...
pub async fn policies_reputation_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_check_ip = check_ip;
    let p_check_username = check_username;
    let p_created = created;
    let p_execution_logging = execution_logging;
    let p_last_updated = last_updated;
    let p_name = name;
    ...
    let p_policy_uuid = policy_uuid;
    let p_search = search;
    let p_threshold = threshold;

    let uri_str = format!("{}/policies/reputation/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_check_ip {
        req_builder = req_builder.query(&[("check_ip", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_check_username {
    ...
    if let Some(ref param_value) = p_threshold {
...
pub async fn policies_reputation_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_uuid = policy_uuid;
    let p_patched_reputation_policy_request = patched_reputation_policy_request;
    ...
    req_builder = req_builder.json(&p_patched_reputation_policy_request);
...
pub async fn policies_reputation_scores_destroy(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_reputation_uuid = reputation_uuid;

    let uri_str = format!(
        "{}/policies/reputation/scores/{reputation_uuid}/",
        configuration.base_path,
        reputation_uuid = crate::apis::urlencode(p_reputation_uuid)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn policies_reputation_scores_list(
    ...
    let p_identifier_in = identifier_in;
    let p_ip = ip;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    ...
    if let Some(ref param_value) = p_identifier_in {
    ...
    if let Some(ref param_value) = p_score {
...
pub async fn policies_unique_password_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_unique_password_policy_request = unique_password_policy_request;
    ...
    req_builder = req_builder.json(&p_unique_password_policy_request);
...
pub async fn policies_unique_password_list(
    ...
    let p_last_updated = last_updated;
    let p_name = name;
    let p_num_historical_passwords = num_historical_passwords;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_password_field = password_field;
    ...
    if let Some(ref param_value) = p_num_historical_passwords {
...
pub async fn policies_unique_password_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_policy_uuid = policy_uuid;
    let p_patched_unique_password_policy_request = patched_unique_password_policy_request;
    ...
    req_builder = req_builder.json(&p_patched_unique_password_policy_request);
