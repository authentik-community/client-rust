...
pub async fn flows_bindings_destroy(
    ...
    let local_var_uri_str = format!(
        ...
        fsb_uuid = crate::apis::urlencode(fsb_uuid)
    );
...
pub async fn flows_executor_get(
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        flow_slug = crate::apis::urlencode(flow_slug)
    );
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn flows_instances_cache_clear_create(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FlowsInstancesCacheClearCreateError> =
...
pub async fn flows_instances_cache_info_retrieve(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FlowsInstancesCacheInfoRetrieveError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn flows_instances_diagram_retrieve(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FlowsInstancesDiagramRetrieveError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn flows_instances_execute_retrieve(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FlowsInstancesExecuteRetrieveError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn flows_instances_export_retrieve(
    configuration: &configuration::Configuration,
    slug: &str,
) -> Result<std::path::PathBuf, Error<FlowsInstancesExportRetrieveError>> {
    let local_var_configuration = configuration;
...
pub async fn flows_instances_set_background_create(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FlowsInstancesSetBackgroundCreateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn flows_instances_set_background_url_create(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FlowsInstancesSetBackgroundUrlCreateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
