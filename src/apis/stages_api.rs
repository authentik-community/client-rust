...
pub async fn stages_all_destroy(
    ...
    let p_stage_uuid = stage_uuid;

    let uri_str = format!(
        "{}/stages/all/{stage_uuid}/",
        configuration.base_path,
        stage_uuid = crate::apis::urlencode(p_stage_uuid)
    );
...
pub async fn stages_authenticator_duo_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_authenticator_duo_stage_request = authenticator_duo_stage_request;
    ...
    req_builder = req_builder.json(&p_authenticator_duo_stage_request);
...
pub async fn stages_authenticator_duo_import_device_manual_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_authenticator_duo_stage_manual_device_import_request = authenticator_duo_stage_manual_device_import_request;
    ...
    req_builder = req_builder.json(&p_authenticator_duo_stage_manual_device_import_request);
...
pub async fn stages_authenticator_duo_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_api_hostname = api_hostname;
    ...
    if let Some(ref param_value) = p_api_hostname {
    ...
    if let Some(ref param_value) = p_configure_flow {
...
pub async fn stages_authenticator_duo_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_authenticator_duo_stage_request = patched_authenticator_duo_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_authenticator_duo_stage_request);
...
pub async fn stages_authenticator_email_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_authenticator_email_stage_request = authenticator_email_stage_request;
    ...
    req_builder = req_builder.json(&p_authenticator_email_stage_request);
...
pub async fn stages_authenticator_email_list(
    ...
    let p_from_address = from_address;
    let p_host = host;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    ...
    let p_token_expiry = token_expiry;
    let p_use_global_settings = use_global_settings;
    let p_use_ssl = use_ssl;
    let p_use_tls = use_tls;
    ...
    if let Some(ref param_value) = p_from_address {
    ...
    if let Some(ref param_value) = p_port {
        req_builder = req_builder.query(&[("port", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_search {
        req_builder = req_builder.query(&[("search", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_stage_uuid {
...
pub async fn stages_authenticator_email_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_authenticator_email_stage_request = patched_authenticator_email_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_authenticator_email_stage_request);
...
pub async fn stages_authenticator_endpoint_gdtc_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_authenticator_endpoint_gdtc_stage_request = authenticator_endpoint_gdtc_stage_request;
    ...
    req_builder = req_builder.json(&p_authenticator_endpoint_gdtc_stage_request);
...
pub async fn stages_authenticator_endpoint_gdtc_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_authenticator_endpoint_gdtc_stage_request = patched_authenticator_endpoint_gdtc_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_authenticator_endpoint_gdtc_stage_request);
...
pub async fn stages_authenticator_sms_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_authenticator_sms_stage_request = authenticator_sms_stage_request;
    ...
    req_builder = req_builder.json(&p_authenticator_sms_stage_request);
...
pub async fn stages_authenticator_sms_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_account_sid = account_sid;
    let p_auth = auth;
    let p_auth_password = auth_password;
    let p_auth_type = auth_type;
    let p_configure_flow = configure_flow;
    let p_friendly_name = friendly_name;
    let p_from_number = from_number;
    ...
    let p_search = search;
    let p_stage_uuid = stage_uuid;
    let p_verify_only = verify_only;

    let uri_str = format!("{}/stages/authenticator/sms/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_account_sid {
        req_builder = req_builder.query(&[("account_sid", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_auth {
        req_builder = req_builder.query(&[("auth", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_auth_password {
    ...
    if let Some(ref param_value) = p_from_number {
        req_builder = req_builder.query(&[("from_number", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_mapping {
    ...
    if let Some(ref param_value) = p_verify_only {
...
pub async fn stages_authenticator_sms_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_authenticator_sms_stage_request = patched_authenticator_sms_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_authenticator_sms_stage_request);
...
pub async fn stages_authenticator_static_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_authenticator_static_stage_request = authenticator_static_stage_request;
    ...
    req_builder = req_builder.json(&p_authenticator_static_stage_request);
...
pub async fn stages_authenticator_static_list(
    ...
    let p_search = search;
    let p_stage_uuid = stage_uuid;
    let p_token_count = token_count;
    let p_token_length = token_length;
    ...
    if let Some(ref param_value) = p_token_count {
        req_builder = req_builder.query(&[("token_count", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_token_length {
...
pub async fn stages_authenticator_static_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_authenticator_static_stage_request = patched_authenticator_static_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_authenticator_static_stage_request);
...
pub async fn stages_authenticator_totp_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_authenticator_totp_stage_request = authenticator_totp_stage_request;
    ...
    req_builder = req_builder.json(&p_authenticator_totp_stage_request);
...
pub async fn stages_authenticator_totp_list(
    ...
    if let Some(ref param_value) = p_digits {
...
pub async fn stages_authenticator_totp_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_authenticator_totp_stage_request = patched_authenticator_totp_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_authenticator_totp_stage_request);
...
pub async fn stages_authenticator_validate_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_authenticator_validate_stage_request = authenticator_validate_stage_request;
    ...
    req_builder = req_builder.json(&p_authenticator_validate_stage_request);
...
pub async fn stages_authenticator_validate_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_configuration_stages = configuration_stages;
    let p_name = name;
    let p_not_configured_action = not_configured_action;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_search = search;
    ...
    if let Some(ref param_value) = p_configuration_stages {
    ...
    if let Some(ref param_value) = p_not_configured_action {
...
pub async fn stages_authenticator_validate_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_authenticator_validate_stage_request = patched_authenticator_validate_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_authenticator_validate_stage_request);
...
pub async fn stages_authenticator_webauthn_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_authenticator_web_authn_stage_request = authenticator_web_authn_stage_request;
    ...
    req_builder = req_builder.json(&p_authenticator_web_authn_stage_request);
...
pub async fn stages_authenticator_webauthn_device_types_list(
    ...
    if let Some(ref param_value) = p_aaguid {
    ...
    if let Some(ref param_value) = p_icon {
...
pub async fn stages_authenticator_webauthn_device_types_retrieve(
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        aaguid = crate::apis::urlencode(p_aaguid)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stages_authenticator_webauthn_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_authenticator_attachment = authenticator_attachment;
    let p_configure_flow = configure_flow;
    ...
    let p_page = page;
    let p_page_size = page_size;
    let p_resident_key_requirement = resident_key_requirement;
    let p_search = search;
    let p_stage_uuid = stage_uuid;
    let p_user_verification = user_verification;

    let uri_str = format!("{}/stages/authenticator/webauthn/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_authenticator_attachment {
        req_builder = req_builder.query(&[("authenticator_attachment", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_configure_flow {
        req_builder = req_builder.query(&[("configure_flow", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_device_type_restrictions {
        req_builder = match "multi" {
            "multi" => req_builder.query(
                &param_value
                    .into_iter()
    ...
    if let Some(ref param_value) = p_resident_key_requirement {
    ...
    if let Some(ref param_value) = p_user_verification {
...
pub async fn stages_authenticator_webauthn_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_authenticator_web_authn_stage_request = patched_authenticator_web_authn_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_authenticator_web_authn_stage_request);
...
pub async fn stages_captcha_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_captcha_stage_request = captcha_stage_request;
    ...
    req_builder = req_builder.json(&p_captcha_stage_request);
...
pub async fn stages_captcha_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_captcha_stage_request = patched_captcha_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_captcha_stage_request);
...
pub async fn stages_consent_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_consent_stage_request = consent_stage_request;
    ...
    req_builder = req_builder.json(&p_consent_stage_request);
...
pub async fn stages_consent_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_consent_expire_in = consent_expire_in;
    let p_mode = mode;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    ...
    if let Some(ref param_value) = p_consent_expire_in {
...
pub async fn stages_consent_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_consent_stage_request = patched_consent_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_consent_stage_request);
...
pub async fn stages_deny_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_deny_stage_request = deny_stage_request;
    ...
    req_builder = req_builder.json(&p_deny_stage_request);
...
pub async fn stages_deny_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_deny_message = deny_message;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    ...
    if let Some(ref param_value) = p_deny_message {
...
pub async fn stages_deny_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_deny_stage_request = patched_deny_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_deny_stage_request);
...
pub async fn stages_dummy_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_dummy_stage_request = dummy_stage_request;
    ...
    req_builder = req_builder.json(&p_dummy_stage_request);
...
pub async fn stages_dummy_list(
    ...
    if let Some(ref param_value) = p_throw_error {
...
pub async fn stages_dummy_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_dummy_stage_request = patched_dummy_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_dummy_stage_request);
...
pub async fn stages_email_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_email_stage_request = email_stage_request;
    ...
    req_builder = req_builder.json(&p_email_stage_request);
...
pub async fn stages_email_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_activate_user_on_success = activate_user_on_success;
    let p_from_address = from_address;
    let p_host = host;
    let p_name = name;
    let p_ordering = ordering;
    ...
    if let Some(ref param_value) = p_activate_user_on_success {
...
pub async fn stages_email_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_email_stage_request = patched_email_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_email_stage_request);
...
pub async fn stages_identification_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_identification_stage_request = identification_stage_request;
    ...
    req_builder = req_builder.json(&p_identification_stage_request);
...
pub async fn stages_identification_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_captcha_stage = captcha_stage;
    let p_case_insensitive_matching = case_insensitive_matching;
    let p_enrollment_flow = enrollment_flow;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_password_stage = password_stage;
    let p_passwordless_flow = passwordless_flow;
    let p_recovery_flow = recovery_flow;
    let p_search = search;
    let p_show_matched_user = show_matched_user;
    let p_show_source_labels = show_source_labels;

    let uri_str = format!("{}/stages/identification/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_captcha_stage {
        req_builder = req_builder.query(&[("captcha_stage", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_case_insensitive_matching {
        req_builder = req_builder.query(&[("case_insensitive_matching", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_enrollment_flow {
...
pub async fn stages_identification_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_identification_stage_request = patched_identification_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_identification_stage_request);
...
pub async fn stages_invitation_invitations_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_invitation_request = invitation_request;
    ...
    req_builder = req_builder.json(&p_invitation_request);
...
pub async fn stages_invitation_invitations_destroy(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_invite_uuid = invite_uuid;

    let uri_str = format!(
        "{}/stages/invitation/invitations/{invite_uuid}/",
        configuration.base_path,
        invite_uuid = crate::apis::urlencode(p_invite_uuid)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_invitation_invitations_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_created_by__username = created_by__username;
    let p_expires = expires;
    let p_flow__slug = flow__slug;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    ...
    if let Some(ref param_value) = p_created_by__username {
    ...
    if let Some(ref param_value) = p_flow__slug {
...
pub async fn stages_invitation_invitations_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_invite_uuid = invite_uuid;
    let p_patched_invitation_request = patched_invitation_request;
    ...
    req_builder = req_builder.json(&p_patched_invitation_request);
...
pub async fn stages_invitation_stages_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_invitation_stage_request = invitation_stage_request;
    ...
    req_builder = req_builder.json(&p_invitation_stage_request);
...
pub async fn stages_invitation_stages_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_continue_flow_without_invitation = continue_flow_without_invitation;
    let p_name = name;
    let p_no_flows = no_flows;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_search = search;
    ...
    if let Some(ref param_value) = p_continue_flow_without_invitation {
        req_builder = req_builder.query(&[("continue_flow_without_invitation", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_name {
        req_builder = req_builder.query(&[("name", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_no_flows {
...
pub async fn stages_invitation_stages_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_invitation_stage_request = patched_invitation_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_invitation_stage_request);
...
pub async fn stages_mtls_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_mutual_tls_stage_request = mutual_tls_stage_request;
    ...
    req_builder = req_builder.json(&p_mutual_tls_stage_request);
...
pub async fn stages_mtls_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_cert_attribute = cert_attribute;
    let p_certificate_authorities = certificate_authorities;
    let p_mode = mode;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    ...
    let p_search = search;
    let p_stage_uuid = stage_uuid;
    let p_user_attribute = user_attribute;

    let uri_str = format!("{}/stages/mtls/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_cert_attribute {
        req_builder = req_builder.query(&[("cert_attribute", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_certificate_authorities {
        req_builder = match "multi" {
            "multi" => req_builder.query(
                &param_value
                    .into_iter()
    ...
    if let Some(ref param_value) = p_user_attribute {
...
pub async fn stages_mtls_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_mutual_tls_stage_request = patched_mutual_tls_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_mutual_tls_stage_request);
...
pub async fn stages_password_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_password_stage_request = password_stage_request;
    ...
    req_builder = req_builder.json(&p_password_stage_request);
...
pub async fn stages_password_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_allow_show_password = allow_show_password;
    let p_configure_flow = configure_flow;
    let p_failed_attempts_before_cancel = failed_attempts_before_cancel;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    ...
    if let Some(ref param_value) = p_allow_show_password {
        req_builder = req_builder.query(&[("allow_show_password", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_configure_flow {
        req_builder = req_builder.query(&[("configure_flow", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_failed_attempts_before_cancel {
...
pub async fn stages_password_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_password_stage_request = patched_password_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_password_stage_request);
...
pub async fn stages_prompt_prompts_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_prompt_request = prompt_request;
    ...
    req_builder = req_builder.json(&p_prompt_request);
...
pub async fn stages_prompt_prompts_destroy(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_prompt_uuid = prompt_uuid;

    let uri_str = format!(
        "{}/stages/prompt/prompts/{prompt_uuid}/",
        configuration.base_path,
        prompt_uuid = crate::apis::urlencode(p_prompt_uuid)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn stages_prompt_prompts_list(
    ...
    if let Some(ref param_value) = p_field_key {
    ...
    if let Some(ref param_value) = p_placeholder {
...
pub async fn stages_prompt_prompts_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_prompt_uuid = prompt_uuid;
    let p_patched_prompt_request = patched_prompt_request;
    ...
    req_builder = req_builder.json(&p_patched_prompt_request);
...
pub async fn stages_prompt_stages_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_prompt_stage_request = prompt_stage_request;
    ...
    req_builder = req_builder.json(&p_prompt_stage_request);
...
pub async fn stages_prompt_stages_list(
    ...
    let p_search = search;
    let p_stage_uuid = stage_uuid;
    let p_validation_policies = validation_policies;
    ...
    if let Some(ref param_value) = p_validation_policies {
        req_builder = match "multi" {
            "multi" => req_builder.query(
                &param_value
                    .into_iter()
...
pub async fn stages_prompt_stages_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_prompt_stage_request = patched_prompt_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_prompt_stage_request);
...
pub async fn stages_redirect_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_redirect_stage_request = redirect_stage_request;
    ...
    req_builder = req_builder.json(&p_redirect_stage_request);
...
pub async fn stages_redirect_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_redirect_stage_request = patched_redirect_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_redirect_stage_request);
...
pub async fn stages_source_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_source_stage_request = source_stage_request;
    ...
    req_builder = req_builder.json(&p_source_stage_request);
...
pub async fn stages_source_list(
    ...
    let p_page = page;
    let p_page_size = page_size;
    let p_resume_timeout = resume_timeout;
    let p_search = search;
    let p_source = source;
    let p_stage_uuid = stage_uuid;
    ...
    if let Some(ref param_value) = p_resume_timeout {
...
pub async fn stages_source_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_source_stage_request = patched_source_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_source_stage_request);
...
pub async fn stages_user_delete_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_delete_stage_request = user_delete_stage_request;
    ...
    req_builder = req_builder.json(&p_user_delete_stage_request);
...
pub async fn stages_user_delete_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_user_delete_stage_request = patched_user_delete_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_user_delete_stage_request);
...
pub async fn stages_user_login_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_login_stage_request = user_login_stage_request;
    ...
    req_builder = req_builder.json(&p_user_login_stage_request);
...
pub async fn stages_user_login_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_geoip_binding = geoip_binding;
    let p_name = name;
    let p_network_binding = network_binding;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    ...
    let p_stage_uuid = stage_uuid;
    let p_terminate_other_sessions = terminate_other_sessions;

    let uri_str = format!("{}/stages/user_login/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_geoip_binding {
        req_builder = req_builder.query(&[("geoip_binding", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_name {
        req_builder = req_builder.query(&[("name", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_network_binding {
    ...
    if let Some(ref param_value) = p_session_duration {
        req_builder = req_builder.query(&[("session_duration", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_stage_uuid {
        req_builder = req_builder.query(&[("stage_uuid", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_terminate_other_sessions {
...
pub async fn stages_user_login_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_user_login_stage_request = patched_user_login_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_user_login_stage_request);
...
pub async fn stages_user_logout_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_logout_stage_request = user_logout_stage_request;
    ...
    req_builder = req_builder.json(&p_user_logout_stage_request);
...
pub async fn stages_user_logout_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_user_logout_stage_request = patched_user_logout_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_user_logout_stage_request);
...
pub async fn stages_user_write_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_user_write_stage_request = user_write_stage_request;
    ...
    req_builder = req_builder.json(&p_user_write_stage_request);
...
pub async fn stages_user_write_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_create_users_as_inactive = create_users_as_inactive;
    let p_create_users_group = create_users_group;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_search = search;
    let p_stage_uuid = stage_uuid;
    let p_user_creation_mode = user_creation_mode;
    let p_user_path_template = user_path_template;
    let p_user_type = user_type;

    let uri_str = format!("{}/stages/user_write/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_create_users_as_inactive {
        req_builder = req_builder.query(&[("create_users_as_inactive", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_create_users_group {
...
pub async fn stages_user_write_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_stage_uuid = stage_uuid;
    let p_patched_user_write_stage_request = patched_user_write_stage_request;
    ...
    req_builder = req_builder.json(&p_patched_user_write_stage_request);
