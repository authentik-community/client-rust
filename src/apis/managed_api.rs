...
pub async fn managed_blueprints_apply_create(
    ...
    let local_var_uri_str = format!(
        ...
        instance_uuid = crate::apis::urlencode(instance_uuid)
    );
...
pub async fn managed_blueprints_available_list(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ManagedBlueprintsAvailableListError> =
...
pub async fn managed_blueprints_partial_update(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ManagedBlueprintsPartialUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
