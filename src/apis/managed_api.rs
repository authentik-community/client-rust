...
pub async fn managed_blueprints_apply_create(
    ...
    let p_instance_uuid = instance_uuid;

    let uri_str = format!(
        "{}/managed/blueprints/{instance_uuid}/apply/",
        configuration.base_path,
        instance_uuid = crate::apis::urlencode(p_instance_uuid)
    );
...
pub async fn managed_blueprints_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_blueprint_instance_request = blueprint_instance_request;
    ...
    req_builder = req_builder.json(&p_blueprint_instance_request);
...
pub async fn managed_blueprints_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_instance_uuid = instance_uuid;
    let p_patched_blueprint_instance_request = patched_blueprint_instance_request;
    ...
    req_builder = req_builder.json(&p_patched_blueprint_instance_request);
