...
pub async fn providers_all_destroy(
    ...
    let uri_str = format!("{}/providers/all/{id}/", configuration.base_path, id = p_id);
...
pub async fn providers_all_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_application__isnull = application__isnull;
    let p_backchannel = backchannel;
    ...
    if let Some(ref param_value) = p_application__isnull {
        req_builder = req_builder.query(&[("application__isnull", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_backchannel {
...
pub async fn providers_all_used_by_list(
    ...
    let uri_str = format!("{}/providers/all/{id}/used_by/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_google_workspace_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_google_workspace_provider_request = google_workspace_provider_request;
    ...
    req_builder = req_builder.json(&p_google_workspace_provider_request);
...
pub async fn providers_google_workspace_groups_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_google_workspace_provider_group_request = google_workspace_provider_group_request;
    ...
    req_builder = req_builder.json(&p_google_workspace_provider_group_request);
...
pub async fn providers_google_workspace_groups_list(
    ...
    let p_page = page;
    let p_page_size = page_size;
    let p_provider__id = provider__id;
    let p_search = search;
    ...
    if let Some(ref param_value) = p_provider__id {
...
pub async fn providers_google_workspace_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_delegated_subject = delegated_subject;
    let p_exclude_users_service_account = exclude_users_service_account;
    let p_filter_group = filter_group;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
...
pub async fn providers_google_workspace_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_google_workspace_provider_request = patched_google_workspace_provider_request;
    ...
    req_builder = req_builder.json(&p_patched_google_workspace_provider_request);
...
pub async fn providers_google_workspace_sync_object_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_sync_object_request = sync_object_request;
    ...
    req_builder = req_builder.json(&p_sync_object_request);
...
pub async fn providers_google_workspace_users_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_google_workspace_provider_user_request = google_workspace_provider_user_request;
    ...
    req_builder = req_builder.json(&p_google_workspace_provider_user_request);
...
pub async fn providers_ldap_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ldap_provider_request = ldap_provider_request;
    ...
    req_builder = req_builder.json(&p_ldap_provider_request);
...
pub async fn providers_ldap_destroy(
    ...
    let uri_str = format!("{}/providers/ldap/{id}/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn providers_ldap_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_application__isnull = application__isnull;
    let p_authorization_flow__slug__iexact = authorization_flow__slug__iexact;
    let p_base_dn__iexact = base_dn__iexact;
    let p_certificate__kp_uuid__iexact = certificate__kp_uuid__iexact;
    let p_certificate__name__iexact = certificate__name__iexact;
    let p_gid_start_number__iexact = gid_start_number__iexact;
    let p_name__iexact = name__iexact;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_search = search;
    let p_tls_server_name__iexact = tls_server_name__iexact;
    let p_uid_start_number__iexact = uid_start_number__iexact;
    ...
    if let Some(ref param_value) = p_tls_server_name__iexact {
        req_builder = req_builder.query(&[("tls_server_name__iexact", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_uid_start_number__iexact {
...
pub async fn providers_ldap_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_ldap_provider_request = patched_ldap_provider_request;
    ...
    req_builder = req_builder.json(&p_patched_ldap_provider_request);
...
pub async fn providers_ldap_used_by_list(
    ...
    let uri_str = format!("{}/providers/ldap/{id}/used_by/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_microsoft_entra_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_microsoft_entra_provider_request = microsoft_entra_provider_request;
    ...
    req_builder = req_builder.json(&p_microsoft_entra_provider_request);
...
pub async fn providers_microsoft_entra_destroy(
    ...
    let uri_str = format!("{}/providers/microsoft_entra/{id}/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn providers_microsoft_entra_groups_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_microsoft_entra_provider_group_request = microsoft_entra_provider_group_request;
    ...
    req_builder = req_builder.json(&p_microsoft_entra_provider_group_request);
...
pub async fn providers_microsoft_entra_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_microsoft_entra_provider_request = patched_microsoft_entra_provider_request;
    ...
    req_builder = req_builder.json(&p_patched_microsoft_entra_provider_request);
...
pub async fn providers_microsoft_entra_users_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_microsoft_entra_provider_user_request = microsoft_entra_provider_user_request;
    ...
    req_builder = req_builder.json(&p_microsoft_entra_provider_user_request);
...
pub async fn providers_oauth2_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_o_auth2_provider_request = o_auth2_provider_request;
    ...
    req_builder = req_builder.json(&p_o_auth2_provider_request);
...
pub async fn providers_oauth2_destroy(
    ...
    let uri_str = format!("{}/providers/oauth2/{id}/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn providers_oauth2_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_access_code_validity = access_code_validity;
    let p_access_token_validity = access_token_validity;
    ...
    let p_include_claims_in_id_token = include_claims_in_id_token;
    let p_issuer_mode = issuer_mode;
    let p_name = name;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_property_mappings = property_mappings;
    let p_refresh_token_validity = refresh_token_validity;
    let p_search = search;
    let p_signing_key = signing_key;
    let p_sub_mode = sub_mode;

    let uri_str = format!("{}/providers/oauth2/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_access_code_validity {
        req_builder = req_builder.query(&[("access_code_validity", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_access_token_validity {
    ...
    if let Some(ref param_value) = p_authorization_flow {
    ...
    if let Some(ref param_value) = p_property_mappings {
...
pub async fn providers_oauth2_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_o_auth2_provider_request = patched_o_auth2_provider_request;
    ...
    req_builder = req_builder.json(&p_patched_o_auth2_provider_request);
...
pub async fn providers_oauth2_preview_user_retrieve(
    ...
    if let Some(ref param_value) = p_for_user {
...
pub async fn providers_oauth2_used_by_list(
    ...
    let uri_str = format!("{}/providers/oauth2/{id}/used_by/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_proxy_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_proxy_provider_request = proxy_provider_request;
    ...
    req_builder = req_builder.json(&p_proxy_provider_request);
...
pub async fn providers_proxy_destroy(
    ...
    let uri_str = format!("{}/providers/proxy/{id}/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn providers_proxy_list(
    ...
    let p_application__isnull = application__isnull;
    let p_authorization_flow__slug__iexact = authorization_flow__slug__iexact;
    let p_basic_auth_enabled__iexact = basic_auth_enabled__iexact;
    let p_basic_auth_password_attribute__iexact = basic_auth_password_attribute__iexact;
    let p_basic_auth_user_attribute__iexact = basic_auth_user_attribute__iexact;
    let p_certificate__kp_uuid__iexact = certificate__kp_uuid__iexact;
    let p_certificate__name__iexact = certificate__name__iexact;
    let p_cookie_domain__iexact = cookie_domain__iexact;
    let p_external_host__iexact = external_host__iexact;
    let p_internal_host__iexact = internal_host__iexact;
    let p_internal_host_ssl_validation__iexact = internal_host_ssl_validation__iexact;
    let p_mode__iexact = mode__iexact;
    let p_name__iexact = name__iexact;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_property_mappings__iexact = property_mappings__iexact;
    let p_search = search;
    let p_skip_path_regex__iexact = skip_path_regex__iexact;
    ...
    if let Some(ref param_value) = p_basic_auth_enabled__iexact {
        req_builder = req_builder.query(&[("basic_auth_enabled__iexact", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_basic_auth_password_attribute__iexact {
        req_builder = req_builder.query(&[("basic_auth_password_attribute__iexact", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_basic_auth_user_attribute__iexact {
    ...
    if let Some(ref param_value) = p_property_mappings__iexact {
        req_builder = match "multi" {
            "multi" => req_builder.query(
                &param_value
                    .into_iter()
    ...
    if let Some(ref param_value) = p_skip_path_regex__iexact {
...
pub async fn providers_proxy_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_proxy_provider_request = patched_proxy_provider_request;
    ...
    req_builder = req_builder.json(&p_patched_proxy_provider_request);
...
pub async fn providers_proxy_used_by_list(
    ...
    let uri_str = format!("{}/providers/proxy/{id}/used_by/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_rac_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_rac_provider_request = rac_provider_request;
    ...
    req_builder = req_builder.json(&p_rac_provider_request);
...
pub async fn providers_rac_destroy(
    ...
    let uri_str = format!("{}/providers/rac/{id}/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn providers_rac_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_rac_provider_request = patched_rac_provider_request;
    ...
    req_builder = req_builder.json(&p_patched_rac_provider_request);
...
pub async fn providers_rac_used_by_list(
    ...
    let uri_str = format!("{}/providers/rac/{id}/used_by/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_radius_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_radius_provider_request = radius_provider_request;
    ...
    req_builder = req_builder.json(&p_radius_provider_request);
...
pub async fn providers_radius_destroy(
    ...
    let uri_str = format!("{}/providers/radius/{id}/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn providers_radius_list(
    ...
    let p_application__isnull = application__isnull;
    let p_authorization_flow__slug__iexact = authorization_flow__slug__iexact;
    let p_client_networks__iexact = client_networks__iexact;
    let p_name__iexact = name__iexact;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    ...
    if let Some(ref param_value) = p_client_networks__iexact {
...
pub async fn providers_radius_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_radius_provider_request = patched_radius_provider_request;
    ...
    req_builder = req_builder.json(&p_patched_radius_provider_request);
...
pub async fn providers_radius_used_by_list(
    ...
    let uri_str = format!("{}/providers/radius/{id}/used_by/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_saml_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_saml_provider_request = saml_provider_request;
    ...
    req_builder = req_builder.json(&p_saml_provider_request);
...
pub async fn providers_saml_destroy(
    ...
    let uri_str = format!("{}/providers/saml/{id}/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn providers_saml_import_metadata_create(
    ...
    let p_name = name;
    let p_authorization_flow = authorization_flow;
    let p_invalidation_flow = invalidation_flow;
    let p_file = file;
    ...
    multipart_form = multipart_form.text("authorization_flow", p_authorization_flow.to_string());
    multipart_form = multipart_form.text("invalidation_flow", p_invalidation_flow.to_string());
...
pub async fn providers_saml_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_acs_url = acs_url;
    let p_assertion_valid_not_before = assertion_valid_not_before;
    let p_assertion_valid_not_on_or_after = assertion_valid_not_on_or_after;
    ...
    let p_invalidation_flow = invalidation_flow;
    let p_is_backchannel = is_backchannel;
    let p_issuer = issuer;
    let p_name = name;
    let p_name_id_mapping = name_id_mapping;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_property_mappings = property_mappings;
    let p_search = search;
    let p_session_valid_not_on_or_after = session_valid_not_on_or_after;
    let p_sign_assertion = sign_assertion;
    let p_sign_response = sign_response;
    let p_signature_algorithm = signature_algorithm;
    let p_signing_kp = signing_kp;
    let p_sp_binding = sp_binding;
    let p_verification_kp = verification_kp;

    let uri_str = format!("{}/providers/saml/", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_acs_url {
        req_builder = req_builder.query(&[("acs_url", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_assertion_valid_not_before {
        req_builder = req_builder.query(&[("assertion_valid_not_before", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_assertion_valid_not_on_or_after {
        req_builder = req_builder.query(&[("assertion_valid_not_on_or_after", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_audience {
    ...
    if let Some(ref param_value) = p_authn_context_class_ref_mapping {
    ...
    if let Some(ref param_value) = p_encryption_kp {
        req_builder = req_builder.query(&[("encryption_kp", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_invalidation_flow {
        req_builder = req_builder.query(&[("invalidation_flow", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_is_backchannel {
    ...
    if let Some(ref param_value) = p_name_id_mapping {
    ...
    if let Some(ref param_value) = p_sp_binding {
...
pub async fn providers_saml_metadata_retrieve(
    ...
    let p_force_binding = force_binding;

    let uri_str = format!("{}/providers/saml/{id}/metadata/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_download {
        req_builder = req_builder.query(&[("download", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_force_binding {
...
pub async fn providers_saml_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_saml_provider_request = patched_saml_provider_request;
    ...
    req_builder = req_builder.json(&p_patched_saml_provider_request);
...
pub async fn providers_saml_used_by_list(
    ...
    let uri_str = format!("{}/providers/saml/{id}/used_by/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_scim_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_scim_provider_request = scim_provider_request;
    ...
    req_builder = req_builder.json(&p_scim_provider_request);
...
pub async fn providers_scim_destroy(
    ...
    let uri_str = format!("{}/providers/scim/{id}/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn providers_scim_groups_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_scim_provider_group_request = scim_provider_group_request;
    ...
    req_builder = req_builder.json(&p_scim_provider_group_request);
...
pub async fn providers_scim_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_scim_provider_request = patched_scim_provider_request;
    ...
    req_builder = req_builder.json(&p_patched_scim_provider_request);
...
pub async fn providers_scim_used_by_list(
    ...
    let uri_str = format!("{}/providers/scim/{id}/used_by/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn providers_scim_users_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_scim_provider_user_request = scim_provider_user_request;
    ...
    req_builder = req_builder.json(&p_scim_provider_user_request);
...
pub async fn providers_ssf_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ssf_provider_request = ssf_provider_request;
    ...
    req_builder = req_builder.json(&p_ssf_provider_request);
...
pub async fn providers_ssf_destroy(
    ...
    let uri_str = format!("{}/providers/ssf/{id}/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn providers_ssf_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_ssf_provider_request = patched_ssf_provider_request;
    ...
    req_builder = req_builder.json(&p_patched_ssf_provider_request);
...
pub async fn providers_ssf_used_by_list(
    ...
    let uri_str = format!("{}/providers/ssf/{id}/used_by/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
