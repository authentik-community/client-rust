...
pub async fn rbac_initial_permissions_create(
    ...
    let p_initial_permissions_request = initial_permissions_request;
    ...
    req_builder = req_builder.json(&p_initial_permissions_request);
...
pub async fn rbac_initial_permissions_destroy(
    ...
    let uri_str = format!("{}/rbac/initial_permissions/{id}/", configuration.base_path, id = p_id);
...
pub async fn rbac_initial_permissions_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_initial_permissions_request = patched_initial_permissions_request;
    ...
    req_builder = req_builder.json(&p_patched_initial_permissions_request);
...
pub async fn rbac_permissions_assigned_by_roles_assign(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_uuid = uuid;
    let p_permission_assign_request = permission_assign_request;
    ...
    req_builder = req_builder.json(&p_permission_assign_request);
...
pub async fn rbac_permissions_assigned_by_roles_list(
    ...
    req_builder = req_builder.query(&[("model", &p_model.to_string())]);
...
pub async fn rbac_permissions_assigned_by_roles_unassign_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_uuid = uuid;
    let p_patched_permission_assign_request = patched_permission_assign_request;
    ...
    req_builder = req_builder.json(&p_patched_permission_assign_request);
...
pub async fn rbac_permissions_list(
    ...
    let p_content_type__app_label = content_type__app_label;
    let p_content_type__model = content_type__model;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    let p_role = role;
    ...
    if let Some(ref param_value) = p_content_type__app_label {
        req_builder = req_builder.query(&[("content_type__app_label", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_content_type__model {
...
pub async fn rbac_permissions_retrieve(
    ...
    let uri_str = format!("{}/rbac/permissions/{id}/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn rbac_permissions_roles_destroy(
    ...
    let uri_str = format!("{}/rbac/permissions/roles/{id}/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn rbac_permissions_roles_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_extra_role_object_permission_request = patched_extra_role_object_permission_request;
    ...
    req_builder = req_builder.json(&p_patched_extra_role_object_permission_request);
...
pub async fn rbac_permissions_roles_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_extra_role_object_permission_request = extra_role_object_permission_request;
    ...
    req_builder = req_builder.json(&p_extra_role_object_permission_request);
...
pub async fn rbac_permissions_users_destroy(
    ...
    let uri_str = format!("{}/rbac/permissions/users/{id}/", configuration.base_path, id = p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn rbac_permissions_users_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_extra_user_object_permission_request = patched_extra_user_object_permission_request;
    ...
    req_builder = req_builder.json(&p_patched_extra_user_object_permission_request);
...
pub async fn rbac_permissions_users_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_extra_user_object_permission_request = extra_user_object_permission_request;
    ...
    req_builder = req_builder.json(&p_extra_user_object_permission_request);
...
pub async fn rbac_roles_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_role_request = role_request;
    ...
    req_builder = req_builder.json(&p_role_request);
...
pub async fn rbac_roles_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_uuid = uuid;
    let p_patched_role_request = patched_role_request;
    ...
    req_builder = req_builder.json(&p_patched_role_request);
