...
pub async fn tasks_schedules_list(
    ...
    let p_paused = paused;
    let p_rel_obj_content_type__app_label = rel_obj_content_type__app_label;
    let p_rel_obj_content_type__model = rel_obj_content_type__model;
    let p_rel_obj_id = rel_obj_id;
    let p_rel_obj_id__isnull = rel_obj_id__isnull;
    let p_search = search;
...
pub async fn tasks_schedules_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_schedule_request = patched_schedule_request;
    ...
    req_builder = req_builder.json(&p_patched_schedule_request);
...
pub async fn tasks_schedules_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_schedule_request = schedule_request;
    ...
    req_builder = req_builder.json(&p_schedule_request);
...
pub async fn tasks_tasks_list(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_actor_name = actor_name;
    let p_aggregated_status = aggregated_status;
    let p_ordering = ordering;
    let p_page = page;
    let p_page_size = page_size;
    ...
    if let Some(ref param_value) = p_aggregated_status {
    ...
    if let Some(ref param_value) = p_queue_name {
...
pub async fn tasks_tasks_retrieve(
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        message_id = crate::apis::urlencode(p_message_id)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
