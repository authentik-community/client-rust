...
pub async fn rac_connection_tokens_destroy(
    ...
    let p_connection_token_uuid = connection_token_uuid;

    let uri_str = format!(
        "{}/rac/connection_tokens/{connection_token_uuid}/",
        configuration.base_path,
        connection_token_uuid = crate::apis::urlencode(p_connection_token_uuid)
    );
...
pub async fn rac_connection_tokens_list(
    ...
    if let Some(ref param_value) = p_session__user {
...
pub async fn rac_connection_tokens_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_connection_token_uuid = connection_token_uuid;
    let p_patched_connection_token_request = patched_connection_token_request;
    ...
    req_builder = req_builder.json(&p_patched_connection_token_request);
...
pub async fn rac_connection_tokens_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_connection_token_uuid = connection_token_uuid;
    let p_connection_token_request = connection_token_request;
    ...
    req_builder = req_builder.json(&p_connection_token_request);
...
pub async fn rac_endpoints_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_endpoint_request = endpoint_request;
    ...
    req_builder = req_builder.json(&p_endpoint_request);
...
pub async fn rac_endpoints_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_pbm_uuid = pbm_uuid;
    let p_patched_endpoint_request = patched_endpoint_request;
    ...
    req_builder = req_builder.json(&p_patched_endpoint_request);
