...
pub async fn tenants_domains_create(
    ...
    let p_domain_request = domain_request;
    ...
    req_builder = req_builder.json(&p_domain_request);
...
pub async fn tenants_domains_destroy(
    ...
    let uri_str = format!("{}/tenants/domains/{id}/", configuration.base_path, id = p_id);
...
pub async fn tenants_domains_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_patched_domain_request = patched_domain_request;
    ...
    req_builder = req_builder.json(&p_patched_domain_request);
...
pub async fn tenants_tenants_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_tenant_request = tenant_request;
    ...
    req_builder = req_builder.json(&p_tenant_request);
...
pub async fn tenants_tenants_create_admin_group_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_tenant_uuid = tenant_uuid;
    let p_tenant_admin_group_request_request = tenant_admin_group_request_request;

    let uri_str = format!(
        "{}/tenants/tenants/{tenant_uuid}/create_admin_group/",
        configuration.base_path,
        tenant_uuid = crate::apis::urlencode(p_tenant_uuid)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_tenant_admin_group_request_request);
...
pub async fn tenants_tenants_create_recovery_key_create(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_tenant_uuid = tenant_uuid;
    let p_tenant_recovery_key_request_request = tenant_recovery_key_request_request;
    ...
    req_builder = req_builder.json(&p_tenant_recovery_key_request_request);
...
pub async fn tenants_tenants_partial_update(
    ...
    // add a prefix to parameters to efficiently prevent name collisions
    let p_tenant_uuid = tenant_uuid;
    let p_patched_tenant_request = patched_tenant_request;
    ...
    req_builder = req_builder.json(&p_patched_tenant_request);
