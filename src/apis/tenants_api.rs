...
pub async fn tenants_tenants_create_admin_group_create(
    ...
    let local_var_uri_str = format!(
        ...
        tenant_uuid = crate::apis::urlencode(tenant_uuid)
    );
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TenantsTenantsCreateAdminGroupCreateError> =
...
pub async fn tenants_tenants_create_recovery_key_create(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TenantsTenantsCreateRecoveryKeyCreateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
