...
pub enum SamlProviderLogoutMethodEnum {
...
impl std::fmt::Display for SamlProviderLogoutMethodEnum {
...
impl Default for SamlProviderLogoutMethodEnum {
    fn default() -> SamlProviderLogoutMethodEnum {
