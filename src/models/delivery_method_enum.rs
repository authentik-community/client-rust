    ...
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::HttpsColonSlashSlashSchemasOpenidNetSlashSeceventSlashRiscSlashDeliveryMethodSlashPush => {
                write!(f, "https://schemas.openid.net/secevent/risc/delivery-method/push")
            }
            Self::HttpsColonSlashSlashSchemasOpenidNetSlashSeceventSlashRiscSlashDeliveryMethodSlashPoll => {
                write!(f, "https://schemas.openid.net/secevent/risc/delivery-method/poll")
            }
        }
    }
}
